  ...
  return (
    <div className="studio">
      <header className="st-head">
        <div>
          <div className="st-eyebrow">The Interview Room · Backend</div>
          <h1 className="st-title">Prompt Studio</h1>
          <p className="st-sub">
        ...
        <div className="st-status">
          <span className={`st-dot ${persisted ? "ok" : "warn"}`} aria-hidden="true" />
          {loading
            ? "Cargando…"
            : persisted
            ? "Guardado en Supabase"
            : "Sin persistir (usando valores por defecto)"}
      ...
      <div className="st-actions">
        <button className="st-btn ghost" type="button" onClick={resetDefaults}>
        ...
        <div className="st-actions-right">
          ...
          <button className="st-btn" type="button" onClick={save} disabled={saveState === "saving"}>
